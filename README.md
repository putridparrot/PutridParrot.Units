...
[![GitHub Releases](https://img.shields.io/github/release/putridparrot/PutridParrot.Units.svg)](https://github.com/putridparrot/PutridParrot.Units/releases)
[![GitHub Issues](https://img.shields.io/github/issues/putridparrot/PutridParrot.Units.svg)](https://github.com/putridparrot/PutridParrot.Units/issues)
...
The "My Unit Conversions" app. uses PutridParrot.Units and can be obtained from the following stores/locations.
